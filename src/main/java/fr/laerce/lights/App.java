...
public class App {
     ...
     */
    public void cycles() {
        // DONE allumer 1000 fois l'éclairage, et faire varier l'intensité en
        // diminuant jusqu'à l'extinction on s'arrête au bout de
        // 1000 fois ou dès que l'éclairage tombe en panne
        int i =0;
        while(i<1000 && eclairage.etat() != -1){
            eclairage.allumer();
